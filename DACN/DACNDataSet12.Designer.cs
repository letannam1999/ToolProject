...
namespace DACN {
    ...
    public partial class DACNDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DACNDataSet12.xsd";
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string FirstName, string MidName, string LastName, string ClassId, string Email, string Phone, System.DateTime Birth, string Status) {
...
namespace DACN.DACNDataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_MidName = 1 AND [MidName] IS NULL) OR ([MidName] = @Original_MidName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_ClassId = 1 AND [ClassId] IS NULL) OR ([ClassId] = @Original_ClassId)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Birth = 1 AND [Birth] IS NULL) OR ([Birth] = @Original_Birth)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([FirstName], [MidName], [LastName], [ClassId], [Email], [Phone], [Birth], [Status]) VALUES (@FirstName, @MidName, @LastName, @ClassId, @Email, @Phone, @Birth, @Status);
SELECT StudentId, FirstName, MidName, LastName, ClassId, Email, Phone, Birth, Status FROM Student WHERE (StudentId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [FirstName] = @FirstName, [MidName] = @MidName, [LastName] = @LastName, [ClassId] = @ClassId, [Email] = @Email, [Phone] = @Phone, [Birth] = @Birth, [Status] = @Status WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_MidName = 1 AND [MidName] IS NULL) OR ([MidName] = @Original_MidName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_ClassId = 1 AND [ClassId] IS NULL) OR ([ClassId] = @Original_ClassId)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Birth = 1 AND [Birth] IS NULL) OR ([Birth] = @Original_Birth)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT StudentId, FirstName, MidName, LastName, ClassId, Email, Phone, Birth, Status FROM Student WHERE (StudentId = @StudentId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, FirstName, MidName, LastName, ClassId, Email, Phone, Birth, Sta" +
                "tus FROM dbo.Student";
        ...
        public virtual int Fill(DACNDataSet1.StudentDataTable dataTable) {
        ...
        public virtual DACNDataSet1.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DACNDataSet1.StudentDataTable dataTable = new DACNDataSet1.StudentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DACNDataSet1.StudentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StudentId, string Original_FirstName, string Original_MidName, string Original_LastName, string Original_ClassId, string Original_Email, string Original_Phone, global::System.Nullable<global::System.DateTime> Original_Birth, string Original_Status) {
        ...
        public virtual int Insert(string FirstName, string MidName, string LastName, string ClassId, string Email, string Phone, global::System.Nullable<global::System.DateTime> Birth, string Status) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_Birth, 
                    string Original_Status) {
            return this.Update(FirstName, MidName, LastName, ClassId, Email, Phone, Birth, Status, Original_StudentId, Original_FirstName, Original_MidName, Original_LastName, Original_ClassId, Original_Email, Original_Phone, Original_Birth, Original_Status, Original_StudentId);
        }
    }
